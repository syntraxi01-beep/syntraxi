...
const instrumentationServices = [
  {
    ...
    body: "Ajustes de parámetros, diagnóstico en sitio y monitoreo de macromedidores y registradores de datos en red.",
  },
  {
    icon: Radio,
    title: "Puesta en marcha e instrumentación",
    sector: "Industria química · Agroindustria · Plantas de procesamiento",
    body: "Configuración, ajustes de parámetros y comunicación inalámbrica o por lazo de sensores de nivel, flujo y presión.",
  },
  {
    icon: Zap,
